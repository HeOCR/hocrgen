...
The immediate acquisition implementation critical path after `F1e` is:
...
5. Move next to `F3` rights-clean modern handwritten acquisition policy/workflow; keep F4c/F4d synthetic follow-ups and F5 publication readiness as separate follow-on milestones.
