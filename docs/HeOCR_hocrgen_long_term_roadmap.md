...
| E2b | E2 | Live-but-cached batch acquisition for vetted NLI seed URLs | no | completed | current ref release-scale acquisition PR |
...
The immediate implementation critical path after `E2b` is:
