...
| F5 | Public beta and publication readiness | F5a, F5b | Public beta gates, publication packaging, dataset-card, checksum/archive manifests, and takedown-ready export handoff | completed-with-blockers |
...
The immediate implementation critical path after `F5b` is:
