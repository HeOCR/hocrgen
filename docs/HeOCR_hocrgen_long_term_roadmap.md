...
| F6g | F6 | Re-run public beta readiness after repo-owned, source-depth, and synthetic-scale inputs exist | no | planned | final convergence only after F6e-F6f evidence exists |
...
- F6b now has verified private-reporting evidence, F6c has current benchmark-reference limitation reporting, and F6d has current privacy/review limitation reporting; F6g should wait for external/input-dependent source-depth and synthetic-scale inputs
