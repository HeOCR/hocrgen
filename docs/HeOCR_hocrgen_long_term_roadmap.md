...
| F6 | Public beta closure and external input integration | F6a, F6b, F6c, F6d, F6e, F6f, F6g | Post-F5 closure roadmap, takedown/private reporting closure, remaining repo-owned blocker closure, source-depth evidence, larger hocrsyngen batch integration, and final readiness rerun | partial |
...
The immediate implementation critical path after `F6b` is:
...
- F6b/F6c/F6d can progress independently when their repo-owned evidence exists; F6b now has verified private-reporting evidence, while F6g should wait for remaining repo-owned closure plus external/input-dependent source-depth and synthetic-scale inputs
