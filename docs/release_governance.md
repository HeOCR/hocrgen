...
For F6d, the required planning notation is:

- notation: `F6d`
- parent milestone: `F6 - Public beta closure and external input integration`
- source: `docs/HeOCR_hocrgen_long_term_roadmap.md`

For F6e, the required planning notation is:

- notation: `F6e`
- parent milestone: `F6 - Public beta closure and external input integration`
- source: `docs/HeOCR_hocrgen_long_term_roadmap.md`

For F6f1, the required planning notation is:

- notation: `F6f1`
- parent milestone: `F6 - Public beta closure and external input integration`
- source: `docs/HeOCR_hocrgen_long_term_roadmap.md`

For F6f2a, the required planning notation is:

- notation: `F6f2a`
- parent milestone: `F6 - Public beta closure and external input integration`
- source: `docs/HeOCR_hocrgen_long_term_roadmap.md`

For F6f2, the required planning notation is:

- notation: `F6f2`
- parent milestone: `F6 - Public beta closure and external input integration`
- source: `docs/hocrsyngen_adapter_preflight_plan.md`
