...
`C6a`, `D1a`, `D2a`, `D3a`, `D4a`, `D4b`, `D5a`, `E1a`, `E2a`, `E2b`, `E3a`, `E4a`, and `F5a` are complete on the current ref. The next planned work after this document should be selected from the long-term roadmap and open issue state.
