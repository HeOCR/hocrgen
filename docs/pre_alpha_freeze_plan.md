...
`C6a`, `D1a`, `D2a`, `D3a`, `D4a`, `D4b`, `D5a`, `E1a`, `E2a`, `E2b`, `E3a`, `E4a`, `F5a`, `F5b`, `F5c`, `F5d`, and `F6a` are complete on the current ref. The next planned work after this document should follow the F6 closure roadmap and open issue state.
