...
- synthetic target scale and caps: a settled hocrgen-owned release/import metadata form plus a larger validated hocrsyngen `generation_manifest.v1` batch for the planned synthetic-control target, plus continued enforcement of public-profile/export cap policy
