...
- resolving the remaining F1 NLI promotion gap and exercising target-scale inventory through the gates for the `27` NLI / `27` Pinkas / `26` BiblIA real-source target
