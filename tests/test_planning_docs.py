...
CURRENT_COMPLETED_NOTATION = "D4a"
NEXT_NOTATION = "D4b"
PLANNING_FILES = [
    Path(".agent-plan.md"),
    Path("README.md"),
...
def test_planning_docs_agree_on_current_and_next_notation() -> None:
    ...
    assert f"| D4 | Expansion and benchmark formation | D4a, D4b | Richer synthetic generation, then synthetic diversity/reporting hardening | partial |" in roadmap
    ...
    assert "The next planned milestone is `D4b`" in Path("docs/pre_alpha_freeze_plan.md").read_text(encoding="utf-8")
